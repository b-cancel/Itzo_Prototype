...
namespace lerpKit
{
    public static class lerpHelper
    {
        ...
        ///     because GD is only asking for a startValue(s) and endValue(s)
        /// </summary>
        public static float calcGuideDistance(Quaternion startQuaternion, Quaternion currQuaternion, Quaternion endQuaternion, guideDistance GD)
        {
            //NOTE: guideDistance.other has no definition for anything but color

            if (GD == guideDistance.distBetween_StartAndCurr)
                return Quaternion.Angle(startQuaternion, currQuaternion);
            else if (GD == guideDistance.distBetween_StartAndEnd)
                return Quaternion.Angle(startQuaternion, endQuaternion);
            else //guideDistance.distBetween_CurrAndEnd
                return Quaternion.Angle(currQuaternion, endQuaternion);
        }
        ...
        public static float calcLerpValue(Quaternion currQuaternion, Quaternion endQuaternion, float guideDistance, float guideTime, unitOfTime UOT_GD, updateLocation UL)
        {
            return calcLerpValue(currQuaternion, endQuaternion, calcLerpVelocity(guideDistance, guideTime, UOT_GD, UL));
        }
        ...
        public static float calcLerpValue(Quaternion currQuaternion, Quaternion endQuaternion, float lerpVelocity_DperF)
        {
            //---calc distance left to travel
            float distToFinish = Quaternion.Angle(currQuaternion, endQuaternion);
